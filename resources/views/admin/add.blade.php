            ...
            <div class="container mx-auto max-w-lg bg-white p-6 rounded-lg shadow-lg">
                <div class="flex justify-between">
                    ...
                    <a href=" {{ route('admin.books') }} "
                        class="mb-4 inline-block bg-indigo-500 text-white px-4 py-2 rounded-lg hover:bg-indigo-600 transition duration-300 ease-in-out">Return
                        Books List</a>
                ...
                <form action=" {{ route('books.store') }} " method="POST" enctype="multipart/form-data">
                    ...
                    {{-- it's integer value --}}
                    <div class="mb-4">
                        <label for="available" class="block text-gray-700 font-semibold mb-2">Available</label>
